...
<script type="text/javascript">
    ...
    <form class="form-horizontal" action="/sys/financialTitle!save.dhtml" method="POST" name="editForm"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="sysFinancialTitle.tl" name="sysFinancialTitle.tl"  value="二级科目" disabled>
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
        ...
        <input type="hidden" name="sysFinancialTitle.titleLevel" id="sysFinancialTitle.titleLevel" value="2">
        <@c.token/>
    </form>
    </@c.joddForm>
</@common.html>