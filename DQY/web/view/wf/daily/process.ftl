...
<div class="r-top clearfix">
    <p class="text-info text-center lead"><strong>费用报销申请</strong><em style="font-size: 14px;color: #B94A48;">(No:${wfReq.reqNo?if_exists})</em></p>
</div>
<!--搜索over-->
                ...
                <tr>
                    <td colspan="2">
                        <div class="control-group" style="margin-bottom: 5px;">
                            ...
                            <div class="controls" style="margin-left: 70px;">
                                <label style="margin-top: 5px;padding-left:5px;font-size: 14px;">${(wfReqDaily.remarks)?if_exists}</label>
                            </div>
                        </div>
                    </td>
                </tr>
