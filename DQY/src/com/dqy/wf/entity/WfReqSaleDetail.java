 ...
 */
@Entity
@Table(name = "WF_REQ_SALE_DETAIL")
public class WfReqSaleDetail extends IdEntity implements Tracker {
    ...
    @Id
    @GeneratedValue(generator="WF_REQ_SALE_DETAIL")
    @GenericGenerator(name="WF_REQ_SALE_DETAIL",strategy="seqhilo",parameters={@Parameter(name="sequence",value="SEQ_WF_REQ_SALE_DETAIL")})
    public Long getId() {
        return id;
    }
