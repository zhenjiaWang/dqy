...
public class XmapiImplServiceLocator extends org.apache.axis.client.Service implements com.dqy.email.XmapiImplService {
    ...
    public com.dqy.email.XmapiImpl getxmapi(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dqy.email.XmapiSoapBindingStub _stub = new com.dqy.email.XmapiSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.dqy.email.XmapiImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dqy.email.XmapiSoapBindingStub _stub = new com.dqy.email.XmapiSoapBindingStub(new java.net.URL(xmapi_address), this);
                _stub.setPortName(getxmapiWSDDServiceName());
                return _stub;
            }
        }
