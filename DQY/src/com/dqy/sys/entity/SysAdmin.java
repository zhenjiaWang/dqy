...
public class SysAdmin extends IdEntity implements Tracker {
    ...
    @Id
    @GeneratedValue(generator="SYS_ADMIN")
    @GenericGenerator(name="SYS_ADMIN",strategy="seqhilo",parameters={@Parameter(name="sequence",value="SEQ_SYS_ADMIN")})
    public Long getId() {
        return id;
    }
